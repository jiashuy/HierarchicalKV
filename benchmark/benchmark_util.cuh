...
enum class API_Select {
  ...
  evict_number = 7,
  find_origin = 8, 
  find_origin_probing = 9,
  find_tlp_probing = 10,
  find_tlp_probing_8bits_uint8_t = 11,
  find_tlp_probing_8bits_uint32_t = 12,
  find_tlp_probing_8bits_uint4 = 13, 
  find_tlp_probing_16bits_uint4 = 14,
  find_8bits_invalid_frequency = 15,
  find_tlp_probing_collect_size = 16,
  find_tlp_probing_8bits_uint8_t_collect_size = 17,
  find_tlp_probing_8bits_uint4_collect_size = 18,
  filter_based_lookup = 19,
  filter_based_lookup_prefetch = 20,
  pipeline_lookup = 21,
  pipeline_bucket_size = 22,
  copying_origin = 23,
